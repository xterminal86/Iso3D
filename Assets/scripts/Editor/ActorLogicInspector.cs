...
public class ActorLogicInspector : Editor 
{
  public override void OnInspectorGUI()
  {
    ...
    al.ActorStatsObject.StrengthStat.Y = EditorGUILayout.IntField("unmodified ", al.ActorStatsObject.StrengthStat.Y);
    ...
    al.ActorStatsObject.DefenceStat.Y = EditorGUILayout.IntField("unmodified ", al.ActorStatsObject.DefenceStat.Y);
    ...
    al.ActorStatsObject.SpeedStat.Y = EditorGUILayout.IntField("unmodified ", al.ActorStatsObject.SpeedStat.Y);
    ...
    al.ActorStatsObject.Hitpoints.Y = EditorGUILayout.IntField("unmodified ", al.ActorStatsObject.Hitpoints.Y);
    ...
    al.ActorStatsObject.UnityPoints.Y = EditorGUILayout.IntField("unmodified ", al.ActorStatsObject.UnityPoints.Y);
